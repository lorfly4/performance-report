...
$id = $_GET['id'];
$query = "SELECT * FROM analisa_tat WHERE id = '$id'";
...
<body>
    <div class="container">
        <h2 class="text-center">Edit Analisa TAT</h2>
        <form method="post">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="analisa" rows="6"
                    name="analisa"><?php echo $analisa['tat']; ?></textarea>
            </div>
...
if (isset($_POST['analisa'])) {
    ...
    $query = "UPDATE analisa_tat SET tat = '$analisa' WHERE id = '$id'";
    $result = mysqli_query($koneksi, $query);
